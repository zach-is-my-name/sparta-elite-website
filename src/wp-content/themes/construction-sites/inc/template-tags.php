...
if ( ! function_exists( 'construction_sites_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function construction_sites_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html( '%s', 'post date', 'construction-sites' ),
...
if ( ! function_exists( 'construction_sites_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function construction_sites_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html( '%s', 'post author', 'construction-sites' ),
...
if ( ! function_exists( 'construction_sites_post_comments' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function construction_sites_post_comments() {
...
if ( ! function_exists( 'construction_sites_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function construction_sites_entry_footer() {
...
if ( ! function_exists( 'construction_sites_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function construction_sites_post_thumbnail() {
...
if( ! function_exists( 'construction_sites_fontawesome_social_icons_lists' ) ) :
	/**
     * Font Awesome
     *
	...
	function construction_sites_fontawesome_social_icons_lists() {
