...
function thinkup_input_footerw1() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'melos') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 1.', 'melos') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'melos' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'melos') . '</a>',
			'</div>';
	};
	echo	'</div>';
}
...
function thinkup_input_footerw2() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'melos') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 2.', 'melos') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'melos' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'melos') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw3() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'melos') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 3.', 'melos') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'melos' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'melos') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw4() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'melos') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 4.', 'melos') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'melos' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'melos') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw5() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'melos') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 5.', 'melos') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'melos' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'melos') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw6() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'melos') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 6.', 'melos') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'melos' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'melos') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_copyright() {
	...
	printf( esc_html__( 'Theme by %1$s. Powered by %2$s.', 'melos' ), '<a href="https://www.thinkupthemes.com/" target="_blank">Think Up Themes Ltd</a>', '<a href="https://www.wordpress.org/" target="_blank">WordPress</a>' ); 
}
